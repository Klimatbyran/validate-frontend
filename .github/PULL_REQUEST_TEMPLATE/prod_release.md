...
- [ ] Any release notes/docs updated (if needed)

## ✅ Checklist

- [ ] Version updated correctly (and changelog/release notes if you use them)
- [ ] Changes QA’d in staging (if applicable)
- [ ] Rollback target recorded above
- [ ] Title follows: `[Prod] Release vX.X.X`
