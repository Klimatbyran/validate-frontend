    ...
    <div className="min-h-screen bg-gray-05 p-8">
      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        <Tabs
          ...
          className="space-y-6"
        >
          <TabsList className="bg-gray-04/80 backdrop-blur-sm border border-gray-03/50 shadow-lg">
          ...
          <AnimatePresence mode="wait" initial={false}>
            ...
            <TabsContent key="results" value="results" asChild>
              ...
              >
                <h2 className="text-xl text-gray-01 mb-4">Resultatöversikt</h2>
