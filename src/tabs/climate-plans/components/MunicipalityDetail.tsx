    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card title="Policy Domain">
          ...
          {ps.policy_domain.mitigation_sections.length > 0 && (
            <div className="mb-3">
          ...
          {ps.policy_domain.source_quotes.length > 0 && (
            <div className="mt-4">
        ...
        <Card title="Goals & Targets">
          ...
          <div className="text-xs font-medium uppercase tracking-wider text-gray-02 mb-2">
            Own commitments ({et.own_commitments.length})
          </div>
          ...
          {et.external_references.length > 0 && (
            <div className="mt-4">
              <div className="text-xs font-medium uppercase tracking-wider text-gray-02 mb-2">
                External references
              </div>
        ...
        <Card title="Spatial Scope">
          ...
          {ps.spatial_scope.source_quotes?.length > 0 && (
            <div className="mt-4">
              <dt className="text-xs font-medium uppercase tracking-wider text-gray-02 mb-2">Source quotes</dt>
        ...
        {/* Timeline */}
        <Card title="Timeline">
          <Field label="Plan period" value={`${ps.temporal_scope.plan_period_start} – ${ps.temporal_scope.plan_period_end}`} />
          ...
          {ps.temporal_scope.interim_milestones.length > 0 && (
            <div className="mb-3">
              <dt className="text-xs font-medium uppercase tracking-wider text-gray-02 mb-1">Interim milestones</dt>
              <dd>
                <ul className="list-disc list-inside text-sm text-gray-01 space-y-0.5">
                  {ps.temporal_scope.interim_milestones.map((m, i) => <li key={i}>{m}</li>)}
                </ul>
              </dd>
            </div>
          )}
        ...
        <Card title="Framework Alignment">
          <div className="flex flex-wrap mb-4">
            <BoolBadge value={et.framework_alignment.paris_agreement_mentioned} label="Paris Agreement" />
            <BoolBadge value={et.framework_alignment.one_point_five_mentioned} label="1.5°C target" />
            <BoolBadge value={et.framework_alignment.carbon_budget_referenced} label="Carbon budget" />
            <BoolBadge value={et.framework_alignment.swedish_climate_act_referenced} label="Swedish Climate Act" />
            <BoolBadge value={et.framework_alignment.swedish_national_targets_referenced} label="National targets" />
            <BoolBadge value={et.framework_alignment.eu_frameworks_referenced} label="EU frameworks" />
          </div>
          ...
          {et.framework_alignment.eu_frameworks_named.length > 0 && (
          ...
          {et.framework_alignment.source_quotes?.length > 0 && (
            <div className="mt-4">
              <dt className="text-xs font-medium uppercase tracking-wider text-gray-02 mb-2">Source quotes</dt>
        ...
        <Card title="Emissions Accounting">
          ...
          {et.emissions_accounting.source_quotes?.length > 0 && (
            <div className="mt-4">
              <dt className="text-xs font-medium uppercase tracking-wider text-gray-02 mb-2">Source quotes</dt>
        ...
        <Card title="Targets Summary">
          ...
          <div className="flex flex-wrap mb-4">
            <BoolBadge value={et.summary.has_quantified_targets} label="Quantified targets" />
            <BoolBadge value={et.summary.has_clear_baseline} label="Clear baseline" />
            <BoolBadge value={et.summary.has_clear_timeline} label="Clear timeline" />
          </div>
