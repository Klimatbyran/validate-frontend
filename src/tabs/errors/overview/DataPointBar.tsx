      ...
      {dp.withAnyData > 0 && (
        <div className="flex gap-3 mt-1.5 text-xs text-gray-02">
          <span className="text-green-400">
            {dp.breakdown.identical} {t("errors.overview.identical")}
          </span>
          <span className="text-yellow-400">
            {dp.breakdown.rounding} {t("errors.overview.rounding")}
          </span>
          <span className="text-purple-400">
            {dp.breakdown.hallucination} {t("errors.overview.hallucination")}
          </span>
          ...
          <span className="text-indigo-400">
            {dp.breakdown.unitError} {t("errors.overview.unitError")}
          </span>
          <span className="text-rose-400">
            {dp.breakdown.smallError} {t("errors.overview.smallError")}
          </span>
          <span className="text-red-400">
            {dp.breakdown.error} {t("errors.overview.error")}
          </span>
        </div>
      )}
    </div>
