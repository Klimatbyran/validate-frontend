...
const BREAKDOWN_ITEMS = [
  ...
  {
    filterKey: "small-error",
    key: "smallError" as const,
    color: "text-rose-400",
  },
  {
    filterKey: "hallucination",
  ...
  {
    filterKey: "category-error",
    key: "categoryError" as const,
    color: "text-cyan-400",
  },
  ...
  return (
    <div>
      ...
      <AggregateMetrics
        metrics={[
          {
            label: t("errors.overview.avgZeroInclusive"),
            rate: aggregates.zeroInclusive,
          },
          {
            label: t("errors.overview.avgApproximate"),
            rate: aggregates.approximate,
          },
          {
            label: t("errors.overview.avgPrecisionTolerant"),
            rate: aggregates.tolerant,
          },
          {
            label: t("errors.overview.avgExactMatch"),
            rate: aggregates.exactMatch,
          },
        ]}
      />
