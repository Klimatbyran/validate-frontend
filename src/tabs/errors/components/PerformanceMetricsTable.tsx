        ...
        <table className="min-w-full text-sm">
          <thead>
            <tr className="text-left text-xs text-gray-02 uppercase tracking-wide">
              <th className="pr-4 py-1.5">{t("errors.metric")}</th>
              <th className="px-4 py-1.5 text-right">{t("errors.count")}</th>
              <th className="px-4 py-1.5 text-right">{t("errors.rate")}</th>
              <th className="pl-4 py-1.5">{t("errors.notes")}</th>
            </tr>
          </thead>
