...
export function ErrorDistributionHistogram({
  distribution,
  barMaxHeight = 300,
}: ErrorDistributionHistogramProps) {
      ...
      >
        {distribution.map((count, errorNum) => {
          ...
          return (
            ...
            >
              {count > 0 && (
                <span className="text-xs text-gray-02 mb-1 font-mono">
                  {count}
                </span>
              )}
              <motion.div
