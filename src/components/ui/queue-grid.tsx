    ...
    <div className="space-y-6">
      ...
      >
        ...
        <div className="relative">
          <div className="overflow-x-auto rounded-lg border border-gray-03/50 shadow-lg hover:shadow-xl transition-shadow duration-300">
            <table className="w-full min-w-[1200px] bg-gray-04/80 backdrop-blur-sm">
              <thead>
                <tr className="border-b border-gray-03 bg-gray-03/10">
                  ...
                  {WORKFLOW_STAGES.map((stage) => (
                    ...
                    >
                      <div className="absolute inset-0 flex items-center justify-center">
                        <div className="transform -rotate-45 origin-center whitespace-nowrap text-sm font-medium group-hover:text-gray-01 transition-colors duration-200">
                          {stage.name}
                        </div>
                      </div>
                    </th>
          ...
          {/* Scroll indicators */}
          <div className="absolute left-0 top-1/2 transform -translate-y-1/2 w-8 h-16 bg-gradient-to-r from-gray-05 to-transparent pointer-events-none z-10 flex items-center justify-center">
            <div className="w-1.5 h-1.5 bg-gray-02 rounded-full opacity-40 animate-pulse"></div>
          </div>
          <div className="absolute right-0 top-1/2 transform -translate-y-1/2 w-8 h-16 bg-gradient-to-l from-gray-05 to-transparent pointer-events-none z-10 flex items-center justify-center">
            <div className="w-1.5 h-1.5 bg-gray-02 rounded-full opacity-40 animate-pulse"></div>
          </div>
        </div>
        ...
        <div className="mt-3 text-center">
          <p className="text-xs text-gray-02/70 flex items-center justify-center space-x-1">
            <span className="opacity-50">←</span>
            <span>Scrolla för att se alla steg</span>
            <span className="opacity-50">→</span>
          </p>
        </div>
      </motion.div>
