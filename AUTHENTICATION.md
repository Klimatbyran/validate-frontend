...
See `BACKEND_AUTH_REQUIREMENTS.md` for detailed backend implementation requirements.
...
- [Deployment Decisions](./DEPLOYMENT_DECISIONS.md) - Architecture decisions including auth
